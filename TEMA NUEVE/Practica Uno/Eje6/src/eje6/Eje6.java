...
public class Eje6 {
    ...
    private static VentanaLista vl;
    ...
    public static String mostrarlistapersonas(String nombre) throws Exception
    {   
        String datos = "";
        ArrayList<String> listapersona = tas.mostrarpersonas(nombre);
