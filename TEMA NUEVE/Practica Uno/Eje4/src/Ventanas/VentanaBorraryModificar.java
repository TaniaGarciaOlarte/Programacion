...
public class VentanaBorraryModificar extends javax.swing.JDialog {
    ...
    private void bBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBorrarActionPerformed
        try 
        {
            Eje4.borrar(String.valueOf(jcNombreEvento.getSelectedItem()),this);
        } 
        catch (Exception ex) 
        {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        try
        {
            Eje4.mostrarnombre(jcNombreEvento);
        }
        catch (Exception e)
        {
            showMessageDialog(this,e.getMessage());
    ...
    private void llenarCombo()
    {
        try
        {
            Eje4.llenarlugar(jcLugar,String.valueOf(jcNombreEvento.getSelectedItem()));
        }
        catch (Exception e)
        {
            showMessageDialog(this,e.getMessage());
    ...
    public void comprobarlugar()
    {
        try
        {
            if (Eje4.comprolugar(String.valueOf(jcLugar.getSelectedItem()),String.valueOf(jcNombreEvento.getSelectedItem())))
               throw new Exception("YA HAY UN EVENTO A ESAS HORAS EN EL LUGAR");
            
            Eje4.modificarlugar(String.valueOf(jcLugar.getSelectedItem()),String.valueOf(jcNombreEvento.getSelectedItem()),this);
        }
        catch (Exception e)
        {
            showMessageDialog(this,e.getMessage());
    ...
    public void modificaraforo()
    {
        try
        {
            Eje4.modificaraforo(aforo,String.valueOf(jcNombreEvento.getSelectedItem()),this);
        }
        catch(Exception e)
        {
            showMessageDialog(this,e.getMessage());
    ...
    public void comprobarfecha()
    {
       try
       {
           ...
           Eje4.modificarfechayhora(fecha,horai,horaf,this,String.valueOf(jcNombreEvento.getSelectedItem()));
       }
       catch (Exception e)
       {
           showMessageDialog(this,e.getMessage());
    ...
    private void jfFechaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jfFechaActionPerformed
        try
        {
            ...
            if (!Eje4.comprobarfecha(fecha,String.valueOf(jcNombreEvento.getSelectedItem())))
    ...
    private void jfAforoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jfAforoActionPerformed
        try
        {
             ...
             if (aforo <= Eje4.cantidadaforo(String.valueOf(jcNombreEvento.getSelectedItem())))
