 ...
 * @author taniagarcia
 */
public class VentanaAcontecimiento extends javax.swing.JDialog {
    ...
    public VentanaAcontecimiento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void tfNombreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNombreActionPerformed
        try
        {
            ...
            if (Eje2.buscarnombre(tfNombre.getText().toUpperCase()))
    ...
    private void bAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarActionPerformed
      try
      {
            if (Eje2.comprobarlugar(String.valueOf(jcLugar.getSelectedItem()), fecha, horai, horaf))
                    throw new Exception ("YA HAY UN ACONTECIMIENTO CREADO EN ESE LUGAR EL MISMO DIA Y ENTRE LAS HORAS INTRODUCIDAS");
                            
            Eje2.insertar(tfNombre.getText().toUpperCase(),String.valueOf(jcLugar.getSelectedItem()),fecha,horai,horaf,aforo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAcontecimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaAcontecimiento dialog = new VentanaAcontecimiento(new javax.swing.JFrame(), true);
