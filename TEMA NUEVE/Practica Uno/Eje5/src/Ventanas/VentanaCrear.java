...
public class VentanaCrear extends javax.swing.JDialog {
    ...
    private void tfNombreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNombreActionPerformed
        try
        {
            ...
            if (Eje5.buscarnombre(tfNombre.getText().toUpperCase()))
    ...
    private void bAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarActionPerformed
      try
      {
            if (Eje5.comprobarlugar(String.valueOf(jcLugar.getSelectedItem()), fecha, horai, horaf))
                    throw new Exception ("YA HAY UN ACONTECIMIENTO CREADO EN ESE LUGAR EL MISMO DIA Y ENTRE LAS HORAS INTRODUCIDAS");
                            
            Eje5.insertar(tfNombre.getText().toUpperCase(),String.valueOf(jcLugar.getSelectedItem()),fecha,horai,horaf,aforo);
