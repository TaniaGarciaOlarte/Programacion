...
public class Eje14 {
    ...
    public static void main(String[] args) 
    {
        try
        {
            ...
            showMessageDialog(null,"El numero real positivo introducido es: " + num);
        }
    ...
    public static String validarnum(int deci) throws Exception
    {
        ...
        do
        {
            try
            {
                ent = showInputDialog("Introduce el numero real positivo con " + deci + " decimales:");
            ...
            {
                showMessageDialog(null,"EL NUMERO REAL POSITIVO INTRODUCIDO ES INCORRECTO");
                error=false;
            }
        }
        while(!error);
